...
<div class="aspNetHidden">
    ...
    <div id="content_left" class="leftStyle">
          <div class="LeftImageDiv"><img src="statics/images/zsfwlogin/zclogin.jpg" title="" alt="" class="LeftImageStyle"></div>
    </div>
            ...
            <div style="float: left">
                ...
                <div class="formtable">
                    <div class="formLine">
                        <div>
                            <span>
                                <img src="statics/images/zsfwlogin/z039.gif"></span><span>登录手机号：<input name="ctl00$ctl00$ContentPlaceHolder1_left$Content_right$name" type="text" maxlength="20" id="ContentPlaceHolder1_left_Content_right_name" class="txt_input"></span></div>
                    </div>
                    <div class="formLine">
                        <div>
                            <span>
                                <img src="statics/images/zsfwlogin/z039.gif"></span><span>登录密码&nbsp;&nbsp;&nbsp;&nbsp;：<input name="ctl00$ctl00$ContentPlaceHolder1_left$Content_right$pwd" type="password" maxlength="20" id="ContentPlaceHolder1_left_Content_right_pwd" class="txt_input"></span></div>
