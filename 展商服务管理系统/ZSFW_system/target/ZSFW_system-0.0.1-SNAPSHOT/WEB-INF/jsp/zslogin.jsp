...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="48754E71">
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="dd"/>
</div>
    <script type="text/javascript">
	//<![CDATA[
    ...
    <div id="PH" style="height:300px;">
        <center>
            <div class="mc_logoBar">
                <div class="mc_logo">
                    <a href=""><img src="statics/images/zsfwlogin/black1.png" border="0" height="220" width="960" complete="complete"></a>
                </div>
            </div>
            ...
            <div id="zhuangtaixinxi" class="mc_state" style="height:20px;vertical-align:middle;line-height:20px;width:960px;background-color:#e63722;Top:300px;">
                ...
                <div style="float: right; margin-right: 30px; cursor: pointer;">
                    &nbsp;&nbsp;|&nbsp;&nbsp;
                    <a id="hylnk_GoLogin" href="index.jsp" style="color: White;">返回首页</a></div>
    ...
    <div id="content_left" class="leftStyle">
         ...
         <div class="LeftImageDiv"><img src="statics/images/zsfwlogin/35a213dd-e1dc-4137-b2c5-8cdcda735816.jpg" title="" alt="" class="LeftImageStyle"></div>
    ...
    <div class="formdiv">
        <div class="backgroundPic">
            ...
            <div style="float: left">
                <div id="right_top">
                    <img src="statics/images/zsfwlogin/z032.gif" style="width: 441px; height: 23px;">
                    </div>
                <div class="titlestr">
                    <div style="text-align: center"><strong><span style="font-size: 18px"><span style="font-size: 18px">展商服务管理系统<br>
                  </span>展商登录</span></strong>
                </div>
            </div>
                ...
                <div class="formtable">
                    <div class="formLine">
                        <div>
                            <span>
                                <img src="statics/images/zsfwlogin/z039.gif"></span><span>用户名：<input name="ctl00$ctl00$ContentPlaceHolder1_left$Content_right$name" type="text" maxlength="20" id="ContentPlaceHolder1_left_Content_right_name" class="txt_input"></span></div>
                    </div>
                    <div class="formLine">
                        <div>
                            <span>
                                <img src="statics/images/zsfwlogin/z039.gif"></span><span>密&nbsp;&nbsp;&nbsp;&nbsp;码：<input name="ctl00$ctl00$ContentPlaceHolder1_left$Content_right$pwd" type="password" maxlength="20" id="ContentPlaceHolder1_left_Content_right_pwd" class="txt_input"></span></div>
                    ...
                    <div style="padding: 10px">
                        <div class="btn-imgg">
                            <input type="image" name="ctl00$ctl00$ContentPlaceHolder1_left$Content_right$ImageButton1" id="ContentPlaceHolder1_left_Content_right_ImageButton1" src="statics/images/zsfwlogin/z041.png" 
                            ...
                            <img src="statics/images/zsfwlogin/z042.gif" class="btn_margin" onclick="_rsClick()" alt="重置">
                            <input id="rs" type="reset" style="display: none;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <span id="ContentPlaceHolder1_left_Content_right_RequiredFieldValidator1" style="display:none;"></span>
    <span id="ContentPlaceHolder1_left_Content_right_RequiredFieldValidator2" style="display:none;"></span>
    <div id="ContentPlaceHolder1_left_Content_right_ValidationSummary1" style="display:none;">
