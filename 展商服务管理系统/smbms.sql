...
INSERT INTO `smbms_bill` VALUES ('19', 'aaaaaaaaaaaa', 'aaaaaaaaa', null, 'a', '12.00', '1111111.00', '1', null, null, null, null, '1');
INSERT INTO `smbms_bill` VALUES ('20', '1111111111', '最代码', null, '最代码', '1111.00', '1111.00', '1', '1', '2017-12-27 11:01:43', null, null, '3');
...
-- ----------------------------
INSERT INTO `smbms_provider` VALUES ('1', 'BJ_GYS001', '北京三木堂商贸有限公司', '长期合作伙伴，主营产品:茅台、五粮液、郎酒、酒鬼酒、泸州老窖、赖茅酒、法国红酒等', '最代码', '13566667777', '北京市丰台区育芳园北路', '010-58858787', '1', '2013-03-21 16:52:07', null, null);
...
CREATE TABLE `smbms_user` (
  ...
  `modifyBy` bigint(20) DEFAULT NULL COMMENT '更新者（userId）',
  `modifyDate` datetime DEFAULT NULL COMMENT '更新时间',
  `idPicpath` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `workPicPath` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `smbms_user` VALUES ('2', 'liming', '最代码', '0000000', '2', '1983-12-10', '13688884457', '北京市东城区前门东大街9号', '2', '1', '2014-12-31 19:52:09', null, null, null, null);
